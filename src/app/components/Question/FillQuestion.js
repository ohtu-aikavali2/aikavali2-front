...
export const FillInQuestion = ({ question, topLeftContent, topRightContent, answered, selectedList, handleSelectedList, dumb }) => {
  ...
  return (
    <div className='fillInQuestion'>
      ...
      <FillInQuestionAnswer question={question} handleSelectedList={handleSelectedList} selectedList={selectedList} dumb={dumb}/>
    </div>
  )
}
